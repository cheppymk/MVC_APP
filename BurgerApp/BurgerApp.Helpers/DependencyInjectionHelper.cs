...
namespace BurgerApp.Helpers
{
    ...
    {
        public static void InjectDbContext(this IServiceCollection services, string? v)
        {
            services.AddDbContext<BurgerAppDbContext>(options =>
            options.UseSqlServer(@"Data Source=(localdb)\\MSSQLLocalDB;Database=BurgerAppDb;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False"));
        }
